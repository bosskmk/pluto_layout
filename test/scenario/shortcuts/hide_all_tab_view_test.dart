      ...
      top: PlutoLayoutContainer(
        ...
        items: [
          PlutoLayoutTabItem(
            ...
            title: 'top1',
            enabled: enableTop1,
            tabViewWidget: const Text('top1 view'),
          ),
          PlutoLayoutTabItem(
            id: 'top2',
            title: 'top2',
            enabled: enableTop2,
            tabViewWidget: const Text('top2 view'),
          ),
        ],
      )),
      ...
      right: PlutoLayoutContainer(
        ...
        items: [
          PlutoLayoutTabItem(
            ...
            tabViewWidget: const Text('right1 view'),
          ),
          PlutoLayoutTabItem(
            id: 'right2',
            title: 'right2',
            enabled: enableRight2,
            tabViewWidget: const Text('right2 view'),
          ),
        ],
      )),
      bottom: PlutoLayoutContainer(
        ...
        items: [
          PlutoLayoutTabItem(
            ...
            tabViewWidget: const Text('bottom1 view'),
          ),
          PlutoLayoutTabItem(
            id: 'bottom2',
            title: 'bottom2',
            enabled: enableBottom2,
            tabViewWidget: const Text('bottom2 view'),
          ),
        ],
      )),
    );
